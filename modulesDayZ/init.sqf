...
DZ_THIRST_SEC = 0.09;	// (original was 0.034) how much per second a healthy player needs to drink to stay normal at rest
DZ_METABOLISM_SEC = 0.05; //  (original was 0.05) how much kcal per second a healthy player needs to maintain basal metabolism at rest
...
DZ_FLAME_HEAT = 0.05;	//degrees per second for heating
